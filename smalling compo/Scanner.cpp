...
enum TokenType {
    ...
    ADDOP, SUBOP, MULOP, DIVOP, COMPARISONOP, ASSIGNMENTOP,
    SEMICOLON, PUNCTUATION, CURLYBRACKET, COMMA,
    NUMBER, ID, STRING_LITERAL, COMMENT, UNKNOWN
};

// Map keywords to token types
unordered_map<string, TokenType> keywords = {
    {"if", IF_KW}, {"then", THEN_KW}, {"else", ELSE_KW}, {"end", END_KW},
    {"repeat", REPEAT_KW}, {"until", UNTIL_KW}, {"read", READ_KW}, {"write", WRITE_KW}
};
...
string tokenTypeToString(TokenType t) {
    ...
    case REPEAT_KW: return "REPEAT_KW";
    ...
    while (i < input.length()) {
        ...
        if (isalpha(input[i])) {
            ...
            */
            ...
            if (i < input.length()) lexeme += input[i];
            ...
            if (tokenType != UNKNOWN) {
                output << input[i] << " --> ";
                switch (tokenType) {
                case ADDOP: output << "ADDOP"<<endl; break;
                case SUBOP: output << "SUBOP"<<endl; break;
                case MULOP: output << "MULOP" << endl; break;
                case DIVOP: output << "DIVOP" << endl; break;
                case COMPARISONOP: output << "COMPARISONOP" << endl; break;
                case SEMICOLON: output << "SEMICOLON" << endl; break;
                case PUNCTUATION: output << "PUNCTUATION" << endl; break;
                case CURLYBRACKET:
                    output << "CURLYBRACKET" << endl;
                  ...
                  /*
                    ...
                    */
                    break;
                case COMMA: output << "COMMA"<<endl; break;
                default: break;
                }
                output << "\r\n"<<endl;
